module CredtCardPractice exposing (..)
...
sumDigits list = List.foldl (+) 0 list
...
my_results =
    [
        "calculations:",
        pr <| toDigits "5452898762612993",
        pr <| toDigitsRev "5452898762612993",
        pr <| doubleSecond [3,9,9,2,1,6,2,6,7,8,9,8,2,5,4,5],
